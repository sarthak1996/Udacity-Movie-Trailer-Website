...
dark_knight = media.Movie('The Dark Knight', "With the help of allies Lt. Jim Gordon (Gary Oldman) and DA Harvey Dent (Aaron Eckhart), Batman (Christian Bale) has been able to keep a tight lid on crime in Gotham City. But when a vile young criminal calling himself the Joker (Heath Ledger) suddenly throws the town into chaos, the caped Crusader begins to tread a fine line between heroism and vigilantism.", 'https://i.kinja-img.com/gawker-media/image/upload/s--A1lC8jc---/c_scale,f_auto,fl_progressive,q_80,w_800/ya4c8rc9pwfcsn8awr1e.jpg', 'https://www.youtube.com/watch?v=EXeTwQWrcwY')
